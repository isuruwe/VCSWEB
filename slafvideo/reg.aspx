<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="slafvideo.reg" %>
...
<body class="content" >
    ...
    <form id="form1" runat="server" action="reg.aspx" method="post" enctype="multipart/form-data">
...
&nbsp;<div class="box-body" style="width:500px;">
    ...
    <thead>
        ...
        <tr>
            <td><input type="text" class="form-group" id="dname" name="dname" placeholder="Display Name"/> </td>  </tr> 
         <tr>    <td><input type="text" class="form-group" id="uname" name="uname" placeholder="Username"/> </td> </tr> 
                          <tr>        <td><input class="form-group" type="password" id="pass" name="pass" placeholder="Password"/> </td> </tr> 
                           <tr>        <td><input class="form-group" type="file" id="flv" name="flv"/> </td> </tr> 
          <tr>        <td> <select id="grp"  name="grp" class="form-group" style="width:290px;margin-left:10px;height:30px;">
              <option value="1">AFBM</option>
                <option value="2">NON AFBM</option>
                <option value="3">COMMAND OFFICERS</option>
              <option value="4">BASE COMMANDERS</option>
              <option value="5">STATION CO's</option>
              <option value="6">AIR OPS CO's</option>
              <option value="7">AIR OPS SUPPORT CO's</option>
               <option value="8">STAFF OFFICERS</option>
              <option value="9" selected>OTHER USERS</option>
              <option value="10">IT USERS</option>
                           </select></td> </tr> 
         <tr>        <td><input type="submit" id="sb" />  <%=Session["suc"] %> </td> </tr> 
    </thead>
</table>
        </div>
